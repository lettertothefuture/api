...
export default {
	...
	// cacheDirectory: "/private/var/folders/jh/hbwc23gj7ss239djl5gykyhh0000gn/T/jest_dx",
	...
	// Use the <rootDir> string token to include the path to your project's root directory.
	// Example: ["<rootDir>/app/"]
